...
public class SMS_Unsent {


    public static final String SMS_TABLE_NAME = "unsent_sms";
    ...
    public static final String CREATE_TABLE1 = "CREATE TABLE "+SMS_TABLE_NAME+
    ...
    public SMS_Unsent(int id, String sender, String message, String timestamp) {
        this.id = id;
        this.sender = sender;
